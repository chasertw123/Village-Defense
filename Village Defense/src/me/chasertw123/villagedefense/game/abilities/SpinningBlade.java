...
public class SpinningBlade extends Ability {
    ...
    public SpinningBlade() throws AbilityCreationException {
        super("Spinning Blade", 3, new int[] { 35, 35, 35 }, new int[] { 6, 5, 4 }, AbilityType.SECONDARY, "This ability spins you around an does scaling damage based on it's level! Use it when in large groups of monsters!");
    }
