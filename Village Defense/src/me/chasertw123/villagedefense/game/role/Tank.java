...
public class Tank extends Role {
    ...
    private static ArrayList<ToolSet> setToolSets() {
        ...
        toolSets.add(new ToolSet(ToolType.CHESTPLATE, new Tool(new FancyItemStack(Material.IRON_CHESTPLATE, ChatColor.GREEN + "" + ChatColor.BOLD + "Tank Chestplate" + Utils.fancyTierString(1)), 0, 1)));
        toolSets.add(new ToolSet(ToolType.LEGGINGS, new Tool(new FancyItemStack(Material.IRON_LEGGINGS, ChatColor.GREEN + "" + ChatColor.BOLD + "Tank Leggings" + Utils.fancyTierString(1)), 0, 1)));
        toolSets.add(new ToolSet(ToolType.BOOTS, new Tool(new FancyItemStack(Material.IRON_BOOTS, ChatColor.GREEN + "" + ChatColor.BOLD + "Tank Boots" + Utils.fancyTierString(1)), 0, 1)));
        toolSets.add(new ToolSet(ToolType.WEAPON, new Tool(new FancyItemStack(Material.IRON_SWORD, ChatColor.GREEN + "" + ChatColor.BOLD + "Tank Weapon" + Utils.fancyTierString(1)), 0, 1)));
